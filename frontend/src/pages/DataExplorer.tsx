...
const SOURCES: DataSource[] = [
  ...
  },
  {
    ...
    sampleFn: async () => [
      ...
      { field: "has_epc",       count: "87,712", "coverage_%": "94%",  source: "EPC Sweden" },
      { field: "address",       count: "71,456", "coverage_%": "77%",  source: "Lantmäteriet" },
      { field: "energy (kWh)",  count: "18,744", "coverage_%": "20%",  source: "EPC Sweden" },
      { field: "eclass (A–G)",  count: "18,744", "coverage_%": "20%",  source: "EPC Sweden" },
      { field: "year",          count: "18,738", "coverage_%": "20%",  source: "EPC Sweden" },
      { field: "tabula_period", count: "18,738", "coverage_%": "20%",  source: "TABULA" },
