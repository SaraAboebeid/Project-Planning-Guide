...
this tool is currently understated.
""",
        },
        {
            "title": "Limitations",
...
|---|---|---|
| **EPSM** | containerised EnergyPlus manager, :8010 | needs Docker running; its end-use schema limits what we can report |
...
NAV = [
    ...
    ("Reference", ["access", "script_browser", "project_team"]),
]
